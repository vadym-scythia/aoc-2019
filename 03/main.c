...
{       
    ...
    int isNext = 0, prevX = centerX, prevY = centerY;
    while (*inputString != '\0')
    {
        int value = 0;
        ...
        case 'R':
            ...
            {
                if (isNext == 1)
                    if (field[prevX][prevY + i] == 1)
                        field[prevX][prevY + i] = 3;
                    else
                        field[prevX][prevY + i] = 2;
                else
                    field[prevX][prevY + i] = 1;
        ...
        case 'U':
            ...
            {
                if (isNext == 1)
                    if (field[prevX + i][prevY] == 1)
                        field[prevX + i][prevY] = 3;
                    else
                        field[prevX + i][prevY] = 2;
                else
                    field[prevX + i][prevY] = 1;
